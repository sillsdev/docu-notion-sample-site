...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: "Sample Docusaurus Site using notion-pull",
        logo: {
          alt: "Logo",
          src: "img/logo.svg",
        },
